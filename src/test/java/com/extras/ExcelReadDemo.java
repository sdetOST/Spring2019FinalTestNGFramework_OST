...
public class ExcelReadDemo {
    ...
    public void readSingleCellValueTest() {
        ...
        Cell cell = row.getCell(0);             // Cell cell =  sheet.getRow(0).getCell(0);
        String value = cell.getStringCellValue();       // String value = sheet.getRow(0).getCell(0).getStringCellValue();
        System.out.println("Value: " + value);          // String value = sheet.getRow(0).getCell(0).toString();
